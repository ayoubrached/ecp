export default function PayoutLocationsPage() {
  return (
    <main>
      <h1 style={{ margin: 0, marginBottom: 8 }}>Payout by Location</h1>
      <p style={{ color: '#374151', marginBottom: 12 }}>
        Upload the timesheets CSV to analyze owed amounts by employee with location filters.
      </p>
      <form action="/api/calculate/locations" method="post" encType="multipart/form-data" style={{ display: 'grid', gap: 8, maxWidth: 480 }}>
